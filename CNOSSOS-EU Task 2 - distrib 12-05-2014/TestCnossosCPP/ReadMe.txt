========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet TestCnossosCPP
========================================================================

AppWizard a créé cette application TestCnossosCPP pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application TestCnossosCPP.


TestCnossosCPP.vcxproj
...
TestCnossosCPP.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé TestCnossosCPP.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
