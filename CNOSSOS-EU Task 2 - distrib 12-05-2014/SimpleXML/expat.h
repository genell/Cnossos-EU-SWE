...
enum XML_Error {
  ...
  /* Added in 1.95.7. */
  XML_ERROR_UNBOUND_PREFIX = 31,
  /* Added in 1.95.8. */
  XML_ERROR_UNDECLARING_PREFIX = 41,
  XML_ERROR_INCOMPLETE_PE = 42,
  XML_ERROR_XML_DECL = 43,
  XML_ERROR_TEXT_DECL = 44,
  XML_ERROR_PUBLICID = 45,
  XML_ERROR_SUSPENDED = 46,
  XML_ERROR_NOT_SUSPENDED = 47,
  XML_ERROR_ABORTED = 48,
  XML_ERROR_FINISHED = 49,
  XML_ERROR_SUSPEND_PE = 50,
  /* Added in 2.0. */
  XML_ERROR_RESERVED_PREFIX_XML = 61,
  XML_ERROR_RESERVED_PREFIX_XMLNS = 62,
  XML_ERROR_RESERVED_NAMESPACE_URI = 63
};
