...
path.source.source.areaSource.area = 10.0;
path.source.source.areaSource.orientation.x = 1.0;
path.source.source.areaSource.orientation.y = 0.0;
path.source.source.areaSource.orientation.z = 0.0;
