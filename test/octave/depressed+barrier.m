...
path.ground.mat = "D"
path.ground.barrier.h = 2.00
path.ground.barrier.mat = "H"
...
path.receiver.pos.x = 10.00
deprbarr10m = cnossos_full(method, path, {}, meteo, {});

% depressed+barrier 20m
path.receiver.pos.x = 20.00
deprbarr20m = cnossos_full(method, path, {}, meteo, {});

% depressed+barrier 50m
path.receiver.pos.x = 50.00
deprbarr50m = cnossos_full(method, path, {}, meteo, {});

% depressed+barrier 100m
path.receiver.pos.x = 100.00
deprbarr100m = cnossos_full(method, path, {}, meteo, {});

% depressed+barrier 200m
path.receiver.pos.x = 200.00
deprbarr200m = cnossos_full(method, path, {}, meteo, {});

% depressed+barrier 500m
path.receiver.pos.x = 500.00
deprbarr500m = cnossos_full(method, path, {}, meteo, {});
